...
TEST(CartanEquiv, TrickyUnknowns) {
  arma::Mat<int> a{{2, 0, 1, 1, 0, 0, 0, 0},
                   {0, 2, 1, 1, 0, 0, 0, 0},
                   {1, 1, 2, 1, 0, 0, 1, 0},
                   {1, 1, 1, 2, 0, 0, 1, 0},
                   {0, 0, 0, 0, 2, 0, 1, 1},
  ...
  arma::Mat<int> e{{2, 0, 1, 1, 0, 0, 0, 0},
                   {0, 2, 1, 1, 0, 0, 0, 0},
                   {1, 1, 2, 1, 0, 0, -1, 0},
                   {1, 1, 1, 2, 0, 0, -1, 0},
                   {0, 0, 0, 0, 2, 0, -1, 1},
...
TEST(CartanEquiv, TrickyUnknownsG) {
  arma::Mat<int> a{{2, 0, 0, 0},
                   {0, 2, 1, 1},
                   {0, 1, 2, 1},
                   {0, 1, 1, 2}};

  arma::Mat<int> e{{2, 0, 0, 0},
                   {0, 2, -1, 1},
                   {0, -1, 2, -1},
                   {0, 1, -1, 2}};
  CartanEquiv equiv;
